...
glslangValidator -V -S vert --D _VS_ shaders/present.glsl -o present.glsl_VS_temp.spv
glslangValidator -V -S frag --D _PS_ shaders/present.glsl -o present.glsl_PS_temp.spv
